    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>设备信息维护</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table :data="ORCARINFQRYZ" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="machineNbr" label="设备编号" sortable width="150">
            </el-table-column>
            <el-table-column prop="machineName" label="名称" width="120">
            </el-table-column>
            <el-table-column prop="machineType" label="类型">
            </el-table-column>
            <el-table-column prop="machineState" label="状态">
            </el-table-column>
        ...
        <el-dialog title="增加设备信息" :visible.sync="addFormVisible" :close-on-click-modal="closeOnclick">
            <el-form :model="ORCARINFEDTX" label-width="80px">
                <el-form-item label="设备编号">
                    <el-input v-model="ORCARINFEDTX.machineNbr" auto-complete="off" maxlength=60 :disabled="isUpdate"></el-input>
                </el-form-item>
                <el-form-item label="名称">
                    <el-input v-model="ORCARINFEDTX.machineName" auto-complete="off" maxlength=100></el-input>
                </el-form-item>
                <el-form-item label="类型">
                    <el-select v-model="ORCARINFEDTX.machineType" placeholder="请选择类型">
                        <el-option label="变压器" value="bianyaqi"></el-option>
                        <el-option label="水泵" value="水泵"></el-option>
                        <el-option label="锅炉" value="锅炉"></el-option>
                        <el-option label="氧气罐" value="氧气罐"></el-option>
                ...
                <el-form-item label="状态">
                    <el-input v-model="ORCARINFEDTX.machineState" auto-complete="off" maxlength=60></el-input>
                </el-form-item>
            </el-form>
