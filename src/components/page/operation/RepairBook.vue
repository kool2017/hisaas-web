<template>
    <div class="table">
        ...
        <el-table :data="ORCARINFQRYZ" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="repairSex" label="电话" width="196"></el-table-column>
            <el-table-column prop="repairYear" label="地址" width="300"></el-table-column>
            <el-table-column prop="repairWhat" label="维修内容" width="440"></el-table-column>
            <el-table-column prop="repairTel" label="状态" width="180"></el-table-column>
        ...
        <el-dialog title="增加报修单" :visible.sync="addFormVisible" :close-on-click-modal="closeOnclick">
            <el-form :model="ORCARINFEDTX" label-width="100px">
                ...
                <el-row :gutter="0">
                <el-col :span="1" :offset="1" :push="2">
                <el-button type="primary" size=small>附件上传<i class="el-icon-upload el-icon--right"></i></el-button>
                <el-upload
